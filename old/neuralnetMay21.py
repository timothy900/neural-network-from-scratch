...
May 21 version 
- implemented ReLU activation function(it's commented out in the 
  NeuralNetwork class's ff_layer() function)
'''
...
# large network
large_network = NeuralNetwork(784, 16, 16, 10)


# print weights and biases of network
# total_parameters = 0
# # for layer
# for layer in large_network.layers:
# 	layer_weights = []
# 	layer_biases = []
# 	# for neuron
# 	for neuron in layer.neurons:
...
# 		total_parameters += len(neuron.weights) + 1
# 	# print(layer_weights)
# 	# print(layer_biases)
